...
<body>
	...
	<div class="collapse navbar-collapse justify-content-end"
		...
		<div class="navbar-nav">
			...
			</a> <a class="nav-item nav-link" href="login">Login<span
				class="sr-only">(current)</span></a> </a> <a
				class="nav-item nav-link active" href="forgot">Forgot Password</a>
		</div>
	</div>
	</nav>
	...
	<div class="container mt-5 mb-5">
		<div class="col-md-6 offset-md-3">
			...
			<form action="handle-forgotPassword" method="post">
				<div class="row">
					<div class="col">
