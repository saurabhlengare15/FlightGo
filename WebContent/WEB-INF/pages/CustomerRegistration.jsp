...
<body>
	...
	<div class="collapse navbar-collapse justify-content-end"
		...
		<div class="navbar-nav">
			...
			</a> <a class="nav-item nav-link active" href="customer-registration">Sign Up<span
	...
	<div class="container mt-5 mb-5">
		<div class="col-md-8 offset-md-2">
			<h2 class="text-center mb-5">Customer | Sign Up</h2>
				...
				<div class="row">
					<div class="col">
						<label for="name">Name:</label> <input type="text"
							...
							placeholder="E.g: Manoj Kumar" required>
					</div>

					<div class="col">
						<label for="email">Email:</label> <input type="email"
							class="form-control" id="customer_email" name="customer_email"
							placeholder="E.g: manoj@gmail.com" required>
					</div>
				</div>
				<br>
				...
				<div class="row">
					<div class="col">
						<label for="username">Username:</label> <input type="text"
							...
							name="customer_username" placeholder="E.g: Manoj111" required>
					</div>
