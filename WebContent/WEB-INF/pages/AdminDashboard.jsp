			...
			<div class="col-sm-4">
				<div class="card">
					<div class="card-body">
						...
						<img src='<c:url value="/resources/images/add-file.png"/>'
							class="mx-auto d-block"><br>
						<p class="card-text">Add new flight to database.</p>
						<a href="add-flight" class="btn btn-primary">Add Flight</a>
					</div>
				</div>
			</div>
			<div class="col-sm-4">
				<div class="card">
					<div class="card-body">
						...
						<img src='<c:url value="/resources/images/management.png"/>'
							class="mx-auto d-block"><br>
						<p class="card-text">Manage all flights.</p>
						<a href="getall" class="btn btn-primary">All Flights</a>
					</div>
				</div>
			</div>
			<div class="col-sm-4">
				<div class="card">
					<div class="card-body">
						...
						<img src='<c:url value="/resources/images/rating.png"/>'
							class="mx-auto d-block"><br>
						<p class="card-text">Check your account details.</p>
						<a href="/Flight_Booking/customer/getall" class="btn btn-primary">All
							Customers</a>
					</div>
				</div>
			</div>
