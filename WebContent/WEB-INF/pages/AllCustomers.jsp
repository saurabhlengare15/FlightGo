...
<body>
	...
	<div class="collapse navbar-collapse justify-content-end"
		...
		<div class="navbar-nav">
			<a class="nav-item nav-link"
				...
				class="nav-item nav-link" href="/Flight_Booking/flight/logout">Logout</a>
		</div>
	</div>
	</nav>
	<div class="container mt-5">
		<div class="row justify-content-center">
			<div class="col-md-12">
				<h2 class="text-center mb-5">All Customers</h2>
				<table class="table table-bordered table-hover">
					...
					<tbody>
						<c:forEach var="cust" items="${customerList}">
							<tr>
								<td class="font-weight-bold">${cust.customer_id}</td>
								<td>${cust.customer_username}</td>
								<td>${cust.customer_email}</td>
								<td><a href="get/${cust.customer_username}"
